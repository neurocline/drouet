...
func buildHugoImportCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "import",
...
Import requires a subcommand, e.g. ` + "`hugo import jekyll <jekyll_root_path> <target_path>`.",
	...
	cmd.AddCommand(buildHugoImportJekyllCmd())

	return cmd
}

// Build "hugo import" command.
func buildHugoImportJekyllCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "jekyll",
...
func importJekyll(cmd *cobra.Command, args []string) error {
